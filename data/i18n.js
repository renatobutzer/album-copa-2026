...
window.I18N = {
  ...
  pt: {
    ...
    jg_thirds:        "Lista dos 3ºs",
    jg_gr:            "Gr",
    jg_thirds_note:   "Os 8 primeiros se classificam (linhas amarelas). Ordem: Pts → SG → GP. A lista só é definitiva quando os 12 grupos terminam — o ✓ marca a vaga confirmada.",
  ...
  en: {
    ...
    jg_thirds:        "3rd-place list",
    jg_gr:            "Gp",
    jg_thirds_note:   "The top 8 qualify (amber rows). Order: Pts → GD → GF. The list is only final once all 12 groups finish — ✓ marks a confirmed spot.",
